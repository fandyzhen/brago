...
export const metadata: Metadata = {
  title: "Pressure Washing Marketing Posts | Brago",
  description:
    "Turn pressure washing before-and-after photos into marketing posts for Google Business Profile, Facebook, Nextdoor, and Instagram.",
};

const HEADLINE_EXAMPLES = [
  "Concrete restored, not replaced.",
  "Eight years of buildup — gone in two hours.",
  "Recent driveway wash in Austin. Before/after says it all.",
  "Soft wash done right — no damage, no streaks.",
...
const CAPTION_EXAMPLES = [
  {
    ...
    text: "Just finished a full driveway and walkway pressure wash in North Austin. The concrete hadn't been cleaned in years — one job and it looks like new. We're licensed and insured, serving Austin and surrounding areas. Check out our Google reviews and give us a call for a free estimate.",
  },
  {
    channel: "Facebook / Nextdoor",
    text: "Another driveway done in the neighborhood! Before and after — this concrete hadn't been washed in years. If your driveway, patio, or siding could use some attention, send us a message. We're local, licensed, and insured. 📍 Serving Austin, TX",
  },
  {
    channel: "Instagram",
    text: "Driveway refresh ✔️ Before → After. Soft wash on the siding + pressure wash on the concrete. Licensed & insured. Link in bio for a quote. #pressurewashing #austintx #beforeandafter",
  },
];
...
const FAQS = [
  {
    ...
    a: "Yes. Brago is built for real job photos, not studio shots. Phone photos — even uneven lighting — work fine. The template handles the layout so your results look polished.",
  },
  {
  ...
  {
    q: "What if my before photo looks worse than I'd like to show?",
    a: "That's actually the point. A dramatic before/after builds more trust than a polished-only photo. The before shows the real problem; the after shows you solved it.",
  },
];
        ...
        <Container className="py-10 md:py-16">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground leading-tight">
              Pressure Washing Marketing Posts
            </h1>
            <p className="mt-5 text-lg md:text-xl text-muted-foreground leading-relaxed">
              Turn finished driveway, patio, siding, and deck jobs into proof posts for Google Business
              Profile, Facebook, Nextdoor, and Instagram.
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Small pressure washing crews do great work every day — driveways, patios, siding, decks.
            ...
            <ul className="mt-6 space-y-3">
              {[
                ...
                "Canva templates take too long when you're finishing jobs all day.",
                "Potential customers trust real job photos more than any ad copy.",
                "You need something you can post every week without overthinking it.",
              ].map((point) => (
                <li key={point} className="flex items-start gap-3 text-sm text-muted-foreground">
                  <span className="mt-1 w-1.5 h-1.5 rounded-full bg-[#1E5EFF] shrink-0" />
                  {point}
                </li>
              ))}
            </ul>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-widest">
              Pressure washing job scenes Brago handles
            </h3>
            {[
              { scene: "Driveways & Concrete", detail: "Before/after contrast is clear — works on every channel." },
              { scene: "Patios & Pool Decks", detail: "Seasonal jobs with dramatic results. Strong Instagram content." },
              { scene: "Siding & Exterior Walls", detail: "Wide shots or detail crops. Great for neighborhood trust-building." },
              { scene: "Decks & Fences", detail: "Wood restoration before/after shows real craftsmanship." },
              { scene: "Walkways & Steps", detail: "Neighborhood-facing results that drive referrals via Nextdoor." },
            ].map((item) => (
      ...
      <div id="examples" className="border-y border-border bg-secondary/30">
        <Container className="py-16 md:py-24">
          ...
          <p className="mt-4 text-muted-foreground max-w-2xl leading-relaxed">
            The results of a pressure wash are completely visible. Unlike services that require expertise to
            evaluate, a clean driveway versus a dirty one is immediately obvious to anyone who sees it. That
            makes before/after photos your most powerful marketing asset — not ads, not testimonials alone.
          </p>
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                channel: "Facebook / Nextdoor",
                use: "Share as a neighborhood update, not an ad. Local crews get the most traction when posts feel like a genuine job share, not a promotion.",
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,18rem)_minmax(0,1fr)] lg:gap-14">
          <div className="lg:sticky lg:top-24 lg:self-start">
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Real questions pressure washing owners asked us before signing up.
              Don&apos;t see yours?{" "}
              <Link
                href="/contact"
