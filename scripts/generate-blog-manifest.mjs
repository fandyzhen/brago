...
async function main() {
  ...
  lines.push("type BlogModuleLoader = () => Promise<unknown>;");
  lines.push("type BlogManifest = Record<string, Record<string, BlogModuleLoader>>;\n");
  lines.push("export const blogModuleLoaders: BlogManifest = {");
